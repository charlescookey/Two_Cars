...
QT_MOC_LITERAL(1, 7, 17), // "ColidedWithSquare"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 4) // "move"

    },
    "Square\0ColidedWithSquare\0\0move"
};
...
void Square::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ColidedWithSquare((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Square::ColidedWithSquare)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Square::ColidedWithSquare(int _t1)
{
